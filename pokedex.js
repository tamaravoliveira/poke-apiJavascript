...
const fetchPokemon = () => { //fetch, faz requisições HTTP e devolve dados da URL.
    ...
    for (let i = 1; i <= 151; i++) { //loop que executa o fetch, obtem resposta e retorna a promise.
        ...
        .then(pokemons => {
            ...
            const lisPokemons = pokemons.reduce((accumulator, pokemon) => {
                ...
                accumulator += ` 
                    ...
                    <img class="card-image" alt="${pokemon.name}" src="${pokemon.sprites.other.home.front_default}"/>
